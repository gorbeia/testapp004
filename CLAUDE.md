...
| Category canvas view | ✅ Done | [ADR-015](docs/decisions/ADR-015-category-canvas-view.md) |
...
| [ADR-015](docs/decisions/ADR-015-category-canvas-view.md) | Category canvas view: pan/zoom graph of people and relations per category | 2026-05-31 |
