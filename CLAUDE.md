...
| Force-directed layout as default on both canvases (selector kept, all engines available) | ✅ Done | [ADR-050](docs/decisions/ADR-050-force-directed-only-canvas.md) |
...
| [ADR-050](docs/decisions/ADR-050-force-directed-only-canvas.md) | Force-directed as default canvas layout; all engines remain selectable | 2026-08-06 |
